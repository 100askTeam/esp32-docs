...
![DShanMCU-Mio_Arduino_chapter2-2_images_001](https://photos.100ask.net/esp32-docs/DShanMCU-Mio/Arduino/chapter2/DShanMCU-Mio_Arduino_chapter2-2_images_001.jpg)
...
![DShanMCU-Mio_Arduino_chapter2-2_images_002](https://photos.100ask.net/esp32-docs/DShanMCU-Mio/Arduino/chapter2/DShanMCU-Mio_Arduino_chapter2-2_images_002.jpg)
...
![DShanMCU-Mio_Arduino_chapter2-2_images_003](https://photos.100ask.net/esp32-docs/DShanMCU-Mio/Arduino/chapter2/DShanMCU-Mio_Arduino_chapter2-2_images_003.jpg)

我们继续进入到 `packages` 目录，看到内容是下图这样的：

![DShanMCU-Mio_Arduino_chapter2-2_images_004](https://photos.100ask.net/esp32-docs/DShanMCU-Mio/Arduino/chapter2/DShanMCU-Mio_Arduino_chapter2-2_images_004.jpg)


我们接下来需要将我们的esp32开发板包(packages)添加进去即可，这个“包”在目录：

![DShanMCU-Mio_Arduino_chapter2-2_images_005](https://photos.100ask.net/esp32-docs/DShanMCU-Mio/Arduino/chapter2/DShanMCU-Mio_Arduino_chapter2-2_images_005.jpg)
...
![DShanMCU-Mio_Arduino_chapter2-2_images_006](https://photos.100ask.net/esp32-docs/DShanMCU-Mio/Arduino/chapter2/DShanMCU-Mio_Arduino_chapter2-2_images_006.jpg)


这样就大功告成，我们打开(重启)我们的 `Arduino IDE` 后，依次选择： `tools->Board' 就能看到多出来了 esp32 的选项：

![DShanMCU-Mio_Arduino_chapter2-2_images_007](https://photos.100ask.net/esp32-docs/DShanMCU-Mio/Arduino/chapter2/DShanMCU-Mio_Arduino_chapter2-2_images_007.jpg)
...
![DShanMCU-Mio_Arduino_chapter2-2_images_008](https://photos.100ask.net/esp32-docs/DShanMCU-Mio/Arduino/chapter2/DShanMCU-Mio_Arduino_chapter2-2_images_008.jpg)
...
![DShanMCU-Mio_Arduino_chapter2-2_images_009](https://photos.100ask.net/esp32-docs/DShanMCU-Mio/Arduino/chapter2/DShanMCU-Mio_Arduino_chapter2-2_images_009.jpg)
